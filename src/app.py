...
# In-memory activity database test
activities = {
    "Chess Club": {
    ...
    "Basketball Team": {
        "description": "Train on shooting, passing, and game strategy for basketball",
    ...
    "Science Club": {
        "description": "Conduct hands-on experiments and explore STEM topics",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
